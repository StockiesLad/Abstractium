...
public interface AbstractRegistrar extends AbstractionApi<AbstractCommonCalls, MinecraftEnvironment> {
    ...
    <FC extends FeatureConfig, F extends Feature<FC>> IdentifiableMimic registerConfiguredFeature(Identifier identifier, F feature, FC config);
    IdentifiableMimic registerPlacedFeature(Identifier identifier, IdentifiableMimic configuredFeatureRegistryEntry, List<PlacementModifier> modifiers);
    <CC extends CarverConfig> Carver<CC> registerCarver(Identifier identifier, Carver<CC> carver);
    IdentifiableMimic registerCarverConfig(Identifier identifier, ConfiguredCarver<?> configuredCarver);
    IdentifiableMimic registerBiome(Identifier identifier, Biome biome);
}
